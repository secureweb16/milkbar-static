...
function MoreProjectSlider({ projects }) {
  ...
  if (projects.length > 0) {
    return (
      <div className="featured_work_slider more_project_slider position-relative z-1 ptb-120">
        <h6 className="text-uppercase letter-spacing-5 text-center">
          More Projects
        </h6>
      </div>
    );
                ...
                <div className="common_work_slide  position-relative">
                  ...
                  <div className="common_work_slide_text position-absolute w-100 h-100 h-100">
                    <div className="workbox_head">
                      ...
                      <p className="font-messina text-uppercase">
                        PROPERTY · BRAND DIRECTION · DEVELOPMENT
                      </p>
                    </div>
                    <svg
                      width="45"
                ...
                <div className="common_work_slide  position-relative">
                  ...
                  <div className="common_work_slide_text position-absolute w-100 h-100 h-100">
                    <div className="workbox_head">
                      ...
                      <p className="font-messina text-uppercase">
                        YACHTING · BRAND DIRECTION · DEVELOPMENT
                      </p>
                    </div>
                    <svg
                      width="45"
...
export default MoreProjectSlider;
