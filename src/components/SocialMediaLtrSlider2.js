...
function SocialMediaLtrSlider(){
    return(
    <div className="social_ltrslider_outer common_social_slider">
        ...
        <div className="social_ltrslider_right">
            <div className="social_ltrslider_wrapper position-relative">
                <Swiper
                    ...
                    slidesPerView={2.8}
                    navigation={false}
                    scrollbar={{ draggable: true, el: '.ltrSlider-swiper-custom-scrollbar2' }}
                    loop={false}
                    breakpoints={{
                        320: {
                        slidesPerView: 1.5,
                ...
                <div className="slider_nav">                
                    <div className="ltrSlider-swiper-custom-scrollbar2 slider_scrollbar"></div>
                </div>
            </div> 
        </div>
